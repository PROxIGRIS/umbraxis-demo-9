          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-foreground/80 max-w-3xl mx-auto leading-relaxed">
                Discover the wonders of science with our expert tutors. From biology to physics, chemistry to earth science, we make learning engaging and memorable.
              </p>
              ...
              >
                ...
                <div className="p-6 rounded-2xl bg-card border border-border hover:border-primary transition-all hover:scale-105">
                  ...
                  <div className="text-sm text-muted-foreground">Higher Test Scores</div>
                </div>
                <div className="p-6 rounded-2xl bg-card border border-border hover:border-primary transition-all hover:scale-105">
                  <FlaskConical className="w-10 h-10 text-primary mx-auto mb-3" />
                  <div className="text-3xl font-bold text-primary mb-2">All Sciences</div>
              ...
              >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {["Biology", "Chemistry", "Physics", "Earth Science", "Environmental Science", "Anatomy", "Astronomy", "General Science"].map((topic, index) => (

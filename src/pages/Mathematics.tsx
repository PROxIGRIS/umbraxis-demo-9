...
import { ArrowRight, Calculator, TrendingUp, Award } from "lucide-react";
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.1]">
                ...
                <span className="block mt-2 text-primary">with Expert Guidance</span>
              </h1>

              <p className="text-lg md:text-xl text-foreground/80 max-w-3xl mx-auto leading-relaxed">
                From basic arithmetic to advanced calculus, our expert tutors make complex mathematical concepts simple and engaging. Build confidence and excel in your math journey.
              </p>
              ...
              >
                ...
                <div className="p-6 rounded-2xl bg-card border border-border hover:border-primary transition-all hover:scale-105">
                  ...
                  <div className="text-3xl font-bold text-primary mb-2">All Levels</div>
                  <div className="text-sm text-muted-foreground">From Basic to Advanced</div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {["Algebra", "Geometry", "Calculus", "Statistics", "Trigonometry", "Pre-Calculus", "Linear Algebra", "Discrete Math"].map((topic, index) => (

...
import { ArrowRight, Languages as LanguagesIcon, Globe, Award } from "lucide-react";
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.1]">
                ...
                <span className="block mt-2 text-primary">with Native Speakers</span>
              </h1>

              <p className="text-lg md:text-xl text-foreground/80 max-w-3xl mx-auto leading-relaxed">
                Master new languages with our expert tutors. From English to Spanish, French to Mandarin, achieve fluency with personalized instruction and cultural insights.
              </p>
              ...
              >
                <div className="p-6 rounded-2xl bg-card border border-border hover:border-primary transition-all hover:scale-105">
                  ...
                  <div className="text-sm text-muted-foreground">Languages Offered</div>
                </div>
                <div className="p-6 rounded-2xl bg-card border border-border hover:border-primary transition-all hover:scale-105">
                  <Award className="w-10 h-10 text-primary mx-auto mb-3" />
                  <div className="text-3xl font-bold text-primary mb-2">1800+</div>
                  <div className="text-sm text-muted-foreground">Fluent Speakers</div>
                </div>
                <div className="p-6 rounded-2xl bg-card border border-border hover:border-primary transition-all hover:scale-105">
                  <LanguagesIcon className="w-10 h-10 text-primary mx-auto mb-3" />
                  <div className="text-3xl font-bold text-primary mb-2">Native</div>
              ...
              <motion.div
                ...
                className="pt-12"
              >
                <h2 className="text-2xl font-bold mb-6">Languages We Teach</h2>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {["English", "Spanish", "French", "German", "Mandarin", "Japanese", "Italian", "Portuguese", "Arabic", "Korean", "Russian", "Hindi"].map((topic, index) => (
